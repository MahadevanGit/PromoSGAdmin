// To parse this data:
//
//   import { Convert, ShopUser } from "./file";
//
//   const shopUser = Convert.toShopUser(json);
//
...
export class Convert {
    public static toShopUser(json: string): ShopUser {
        return cast(JSON.parse(json), r("ShopUser"));
    }

    public static shopUserToJson(value: ShopUser): string {
        return JSON.stringify(uncast(value, r("ShopUser")), null, 2);
    }
}
...
const typeMap: any = {
    "ShopUser": o([
        { json: "aboutShop", js: "aboutShop", typ: "" },
        { json: "address", js: "address", typ: r("Address") },
        { json: "email", js: "email", typ: "" },
        { json: "fax", js: "fax", typ: "" },
        { json: "firstname", js: "firstname", typ: "" },
        { json: "hotline", js: "hotline", typ: "" },
        { json: "isAdmin", js: "isAdmin", typ: true },
        { json: "lastname", js: "lastname", typ: "" },
        { json: "modifiedAt", js: "modifiedAt", typ: "" },
        { json: "outletList", js: "outletList", typ: a(r("OutletList")) },
        { json: "registeredAt", js: "registeredAt", typ: "" },
        { json: "shopLogo", js: "shopLogo", typ: "" },
